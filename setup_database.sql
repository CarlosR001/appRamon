-- SQL SCRIPT PARA UNA INSTALACIÓN LIMPIA DE ELECTRO-PRO (MySQL)
...
('access_dashboard', 'Acceder al Dashboard'), ('access_sales', 'Acceder al TPV de Ventas'), ('access_purchases', 'Acceder al módulo de Compras'),
('access_inventory', 'Acceder al Inventario'), ('access_clients', 'Acceder a Clientes'), ('access_services', 'Acceder a Servicios'),
('access_sales_history', 'Acceder al Historial de Ventas y anular ventas'), ('access_suppliers', 'Acceder a Proveedores'),
('access_expenses', 'Acceder a Gastos'), ('access_reports', 'Acceder a todos los Reportes'), ('access_users', 'Acceder a la Gestión de Usuarios');
