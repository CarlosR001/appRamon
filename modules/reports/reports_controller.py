    ...
    def load_cash_balance_data(self):
        ...
        try:
            ...
            if balance_data:
                ...
                # --- CORRECCIÓN CLAVE ---
                # Calcular el balance y guardarlo en el diccionario para imprimir
                sales = balance_data.get('total_sales', 0.0)
                expenses = balance_data.get('total_expenses', 0.0)
                balance_data['balance'] = sales - expenses
                balance_data['date'] = balance_date
