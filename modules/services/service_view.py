...
class ServicesView(ttk.Frame):
    ...
    def set_controller(self, controller):
        ...
        self.manage_button.config(command=self.controller.show_update_service_window)
    ...
    def create_services_treeview(self):
        ...
        self.tree.heading("id", text="ID Orden"); self.tree.heading("cliente", text="Cliente"); self.tree.heading("equipo", text="Equipo"); self.tree.heading("estado", text="Estado"); self.tree.heading("fecha", text="Fecha Recepción")
        self.tree.column("id", width=80, anchor=tk.CENTER); self.tree.column("cliente", width=200); self.tree.column("equipo", width=250); self.tree.column("estado", width=120, anchor=tk.CENTER); self.tree.column("fecha", width=150, anchor=tk.W)
    ...
    def create_action_buttons(self):
        """Crea los botones de acción (CORREGIDO Y SIMPLIFICADO)."""
        ...
        self.manage_button = ttk.Button(button_frame, text="Gestionar Servicio Seleccionado")
    ...
    def insert_service(self, service):
        ...
        self.tree.insert("", "end", iid=service['id'], values=(
            service['id'], service.get('nombre_cliente', 'N/A'),
            service.get('descripcion_equipo', ''), estado, fecha
        ))
